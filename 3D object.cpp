...
int main()
{
 ...
 float xa1,ya1,xb,yb,xc1,yc1,xa2,ya2,xc2,yc2,z;
 float co,si,t;
 ...
 printf("\nEnter z coordinate");
 scanf("%f",&z);
 printf("Inital coordinates are (%f,%f)&(%f,%f)",xa1,ya1,xa2,ya2);
 xa1=cox(xa1);
 ya1=coy(ya1);
 xa2=cox(xa2);
 ya2=coy(ya2);
 ...
 scanf("%d",&opt1);
  ...
  setcolor(4);
  bar3d(xc1,yc1,xc2,yc2,z,1);
  printf("\nFinal coordinates are (%f,%f)&(%f,%f)",(xc1-maxx/2)/n,(maxy/2-yc1)/n,(xc2-maxx/2)/n,(maxy/2-yc2)/n);
  getch();
  closegraph();
}
